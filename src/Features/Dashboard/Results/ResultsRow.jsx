...
function ResultsRow({ handleSelectCourse, course }) {
  return (
    <tr className="hover:bg-gray-50 transition-colors">
      <td className="px-2 py-2 sm:px-6 sm:py-4 text-sm font-medium text-gray-900">
        {course.code}
      </td>
      <td className="px-2 py-2 sm:px-6 sm:py-4 text-sm text-gray-500">
        {course.title}
      </td>
      <td className="px-2 py-2 sm:px-6 sm:py-4 text-sm text-gray-500 text-center">
        {course.units}
      </td>
      <td className="px-2 py-2 sm:px-6 sm:py-4 text-sm text-gray-500 text-center">
